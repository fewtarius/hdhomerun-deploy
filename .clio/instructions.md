...
**Format:**
- `YYYYMMDD` = Date (e.g., `20260306`)
- `HHMM` = Time in UTC (e.g., `1746` for 17:46)
...
2. **Current State** - git activity, files modified/created, known issues
...
2. **Task Breakdown** - For each task: status, effort, dependencies, files, success criteria
...
- Script conventions and patterns
- Testing procedures
